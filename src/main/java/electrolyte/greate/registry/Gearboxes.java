...
public class Gearboxes {
    ...
    public static final BlockEntry<TieredGearboxBlock> STEEL_GEARBOX = gearbox("steel_gearbox", TIER.LOW, GreatePartialModels.STEEL_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> ALUMINIUM_GEARBOX = gearbox("aluminium_gearbox", TIER.MEDIUM, GreatePartialModels.ALUMINIUM_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> STAINLESS_STEEL_GEARBOX = gearbox("stainless_steel_gearbox", TIER.HIGH, GreatePartialModels.STAINLESS_STEEL_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> TITANIUM_GEARBOX = gearbox("titanium_gearbox", TIER.EXTREME, GreatePartialModels.TITANIUM_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> TUNGSTENSTEEL_GEARBOX = gearbox("tungstensteel_gearbox", TIER.INSANE, GreatePartialModels.TUNGSTENSTEEL_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> PALLADIUM_GEARBOX = gearbox("palladium_gearbox", TIER.LUDICRIOUS, GreatePartialModels.PALLADIUM_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> NAQUADAH_GEARBOX = gearbox("naquadah_gearbox", TIER.ZPM, GreatePartialModels.NAQUADAH_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> DARMSTADTIUM_GEARBOX = gearbox("darmstadtium_gearbox", TIER.ULTIMATE, GreatePartialModels.DARMSTADTIUM_SHAFT_HALF);
    ...
    public static final BlockEntry<TieredGearboxBlock> NEUTRONIUM_GEARBOX = gearbox("neutronium_gearbox", TIER.ULTIMATE_HIGH, GreatePartialModels.NEUTRONIUM_SHAFT_HALF);
    ...
    public static BlockEntry<TieredGearboxBlock> gearbox(String name, TIER tier, PartialModel halfShaftModel) {
        return REGISTRATE
                .block(name, p -> new TieredGearboxBlock(p, halfShaftModel))
                .initialProperties(SharedProperties::stone)
                .properties(Properties::noOcclusion)
                // .properties(p -> p.color(MaterialColor.PODZOL).pushReaction(PushReaction.PUSH_ONLY))
