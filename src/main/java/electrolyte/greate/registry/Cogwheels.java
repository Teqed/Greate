...
public class Cogwheels {
    ...
    public static final BlockEntry<TieredCogwheelBlock> ANDESITE_COGWHEEL = registerCogwheel("andesite_cogwheel", TIER.ULTRA_LOW, GreatePartialModels.LARGE_ANDESITE_COGWHEEL_SHAFTLESS, GreatePartialModels.ANDESITE_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_ANDESITE.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_ANDESITE_COGWHEEL = registerLargeCogwheel("large_andesite_cogwheel", TIER.ULTRA_LOW, GreatePartialModels.LARGE_ANDESITE_COGWHEEL_SHAFTLESS, GreatePartialModels.ANDESITE_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_ANDESITE.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> STEEL_COGWHEEL = registerCogwheel("steel_cogwheel", TIER.LOW, GreatePartialModels.LARGE_STEEL_COGWHEEL_SHAFTLESS, GreatePartialModels.STEEL_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_STEEL.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_STEEL_COGWHEEL = registerLargeCogwheel("large_steel_cogwheel", TIER.LOW, GreatePartialModels.LARGE_STEEL_COGWHEEL_SHAFTLESS, GreatePartialModels.STEEL_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_STEEL.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> ALUMINIUM_COGWHEEL = registerCogwheel("aluminium_cogwheel", TIER.MEDIUM, GreatePartialModels.LARGE_ALUMINIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.ALUMINIUM_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_ALUMINIUM.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_ALUMINIUM_COGWHEEL = registerLargeCogwheel("large_aluminium_cogwheel", TIER.MEDIUM, GreatePartialModels.LARGE_ALUMINIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.ALUMINIUM_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_ALUMINIUM.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> STAINLESS_STEEL_COGWHEEL = registerCogwheel("stainless_steel_cogwheel", TIER.HIGH, GreatePartialModels.LARGE_STAINLESS_STEEL_COGWHEEL_SHAFTLESS, GreatePartialModels.STAINLESS_STEEL_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_STAINLESS_STEEL.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_STAINLESS_STEEL_COGWHEEL = registerLargeCogwheel("large_stainless_steel_cogwheel", TIER.HIGH, GreatePartialModels.LARGE_STAINLESS_STEEL_COGWHEEL_SHAFTLESS, GreatePartialModels.STAINLESS_STEEL_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_STAINLESS_STEEL.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> TITANIUM_COGWHEEL = registerCogwheel("titanium_cogwheel", TIER.EXTREME, GreatePartialModels.LARGE_TITANIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.TITANIUM_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_TITANIUM.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_TITANIUM_COGWHEEL = registerLargeCogwheel("large_titanium_cogwheel", TIER.EXTREME, GreatePartialModels.LARGE_TITANIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.TITANIUM_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_TITANIUM.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> TUNGSTENSTEEL_COGWHEEL = registerCogwheel("tungstensteel_cogwheel", TIER.INSANE, GreatePartialModels.LARGE_TUNGSTENSTEEL_COGWHEEL_SHAFTLESS, GreatePartialModels.TUNGSTENSTEEL_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_TUNGSTENSTEEL.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_TUNGSTENSTEEL_COGWHEEL = registerLargeCogwheel("large_tungstensteel_cogwheel", TIER.INSANE, GreatePartialModels.LARGE_TUNGSTENSTEEL_COGWHEEL_SHAFTLESS, GreatePartialModels.TUNGSTENSTEEL_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_TUNGSTENSTEEL.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> PALLADIUM_COGWHEEL = registerCogwheel("palladium_cogwheel", TIER.LUDICRIOUS, GreatePartialModels.LARGE_PALLADIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.PALLADIUM_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_PALLADIUM.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_PALLADIUM_COGWHEEL = registerLargeCogwheel("large_palladium_cogwheel", TIER.LUDICRIOUS, GreatePartialModels.LARGE_PALLADIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.PALLADIUM_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_PALLADIUM.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> NAQUADAH_COGWHEEL = registerCogwheel("naquadah_cogwheel", TIER.ZPM, GreatePartialModels.LARGE_NAQUADAH_COGWHEEL_SHAFTLESS, GreatePartialModels.NAQUADAH_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_NAQUADAH.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_NAQUADAH_COGWHEEL = registerLargeCogwheel("large_naquadah_cogwheel", TIER.ZPM, GreatePartialModels.LARGE_NAQUADAH_COGWHEEL_SHAFTLESS, GreatePartialModels.NAQUADAH_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_NAQUADAH.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> DARMSTADTIUM_COGWHEEL = registerCogwheel("darmstadtium_cogwheel", TIER.ULTIMATE, GreatePartialModels.LARGE_DARMSTADTIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.DARMSTADTIUM_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_DARMSTADTIUM.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_DARMSTADTIUM_COGWHEEL = registerLargeCogwheel("large_darmstadtium_cogwheel", TIER.ULTIMATE, GreatePartialModels.LARGE_DARMSTADTIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.DARMSTADTIUM_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_DARMSTADTIUM.itemTag);
    ...
    public static final BlockEntry<TieredCogwheelBlock> NEUTRONIUM_COGWHEEL = registerCogwheel("neutronium_cogwheel", TIER.ULTIMATE_HIGH, GreatePartialModels.LARGE_NEUTRONIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.NEUTRONIUM_COGWHEEL_SHAFT, GreateItemTags.COGWHEELS_NEUTRONIUM.itemTag);
    public static final BlockEntry<TieredCogwheelBlock> LARGE_NEUTRONIUM_COGWHEEL = registerLargeCogwheel("large_neutronium_cogwheel", TIER.ULTIMATE_HIGH, GreatePartialModels.LARGE_NEUTRONIUM_COGWHEEL_SHAFTLESS, GreatePartialModels.NEUTRONIUM_COGWHEEL_SHAFT, GreateItemTags.LARGE_COGWHEELS_NEUTRONIUM.itemTag);
    ...
    public static BlockEntry<TieredCogwheelBlock> registerCogwheel(String name, TIER tier, PartialModel largeCogwheelShaftless, PartialModel cogwheelShaft, TagKey<Item> smallCogwheelTag) {
        return REGISTRATE
    ...
    public static BlockEntry<TieredCogwheelBlock> registerLargeCogwheel(String name, TIER tier, PartialModel largeCogwheelShaftless, PartialModel cogwheelShaft, TagKey<Item> largeCogwheelTag) {
        return REGISTRATE
